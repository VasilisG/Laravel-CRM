...
<div {{ $attributes->merge(['class' => 'rounded border border-gray-300 p-4 min-w-[300px]'])->filter(fn ($value, $key) => $key != 'data') }}>
  <div class="stats-title-container flex justify-between items-center border-b">
    <h2 class="stats-title text-3xl font-semibold pb-2">{{ $title }}</h2>
